...
class Greedy_Switch(Player):        
    def choose_move(self, battle):
        ...
        if battle.available_moves:
            ...
            if spd_diff > -10 and opp_multiplier > 1 and not battle.trapped and switched_last_turn == False:
                if  phy_dmg > -80 or special_dmg > -60 or opp_multiplier > 2:
            ...
            if (2 * best_move_multiplier < opp_multiplier) and not battle.trapped and switched_last_turn == False:
                for switch in battle.available_switches:
            ...
            switched_last_turn = False
            remain_team = len([mon for mon in battle.team.values() if mon.fainted]) / 6 
            ...
            #print(n)
            if n >= 600 and battle.can_dynamax == True:
                dyn = True
            elif n >= 520 and remain_team < 3 and battle.can_dynamax == True:
                dyn = True                   
...
async def main():
    ...
    await greedy_switch_player.battle_against(greedy_player,n_battles = 200)
